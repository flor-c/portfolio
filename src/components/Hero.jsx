  ...
  return (
    <div name='hero' className='w-full h-screen'>
        ...
        <div className='max-w-[1000px] mx-auto p-8 flex flex-col justify-center h-full'>
            ...
            <p className='text-slate-500 py-4 max-w-[700px]'>I'm a frontend developer specialising in building and creating exceptional digital experiences. Currently, I'm focusing on building responsive web applications.</p>
            <div>
